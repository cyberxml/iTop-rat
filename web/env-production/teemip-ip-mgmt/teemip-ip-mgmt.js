	...
	this.DisplayCreationForm = function()
	{
		...
		me.ajax_request = $.post(GetAbsoluteUrlModulesRoot()+'teemip-ip-mgmt/ajax.teemip-ip-mgmt.php',
			...
			function(data) {
				...
				if ((me.sTargetClass == 'IPv4Subnet') || (me.sTargetClass == 'IPv6Subnet') || (me.sTargetClass == 'IPv4Address') || (me.sTargetClass == 'IPv6Address'))
				{
					$('#dialog_content').dialog({modal: true, width: 850});
				}
				else
				{
					$('#dialog_content').dialog({modal: true, width: 500});
				}
